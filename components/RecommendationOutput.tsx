...
import { AnalysisResult, DrugInteraction, Medication } from '@/lib/types'
            ...
            {result.interactions.map((interaction: DrugInteraction, i: number) => (
              ...
              >
                <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                  ...
                  <span
                    className={`ml-auto text-xs px-2 py-0.5 rounded-full font-medium ${SEVERITY_BADGE[interaction.severity] ?? SEVERITY_BADGE.mild}`}
                  >
